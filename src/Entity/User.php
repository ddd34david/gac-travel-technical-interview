...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    /**
     * @ORM\OneToMany(targetEntity=StockHistoric::class, mappedBy="my_user")
     */
    ...
    public function removeStockHistoric(StockHistoric $stockHistoric): self
    {
        if ($this->stockHistorics->removeElement($stockHistoric)) {
            ...
            if ($stockHistoric->getMyUser() === $this) {
                $stockHistoric->setMyUser(null);
            }
        }
